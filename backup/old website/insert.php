...
#========================Q U E R Y======================================//
$sql="insert into demo (fname,lname,email,pass,date,gender,address,state,mobile,cpass,image) values ('$fname','$lname','$email','$pas','$date','$gender','$address','$state','$mobile','$cpass','$target_path')";
