...
#========================Q U E R Y======================================//
$sql="insert into worker (wname,fname,what,date,gender,address,type,mobile,image,ID) values ('$worker_name','$fname','$whats','$date','$gender','$address','$wtype','$mobile','$img','$target_path')";
