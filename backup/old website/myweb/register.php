...
<font color="Green" size="4"> <marquee behavior="scroll" direction="left" scrollamount="4" onmouseover="this.stop();" onmouseout="this.start();" bgcolor="Yellow"><strong>NOTE : </strong> <font color="RED">Visiting / Inspection charges will be applying 150 only.</font>

"This money is 100% redeemable if you decide to use our services after the inspection"

All fields are mandatory you can also request on our whatsapp no. 7000636149</marquee></font>
		<font color="Blue">	<h2>Book workers</h2></font>
			</div>
...
<tr>
<td><b>Full Name:</b></td>
<td><input type='text' name='fn' placeholder='Full Name' required></td>
</tr>
<tr>
...
<tr>
<td><b>Mobile no*  </b></td>
<td><input type='mobile' name='mob' placeholder='99xx-xx-xxxx'required></td>
</tr>
<td><b>Email:</b></td>
...
<tr>
<td><b>Address:</b></td>
<td><textarea rows='3' cols='25' name='add' placeholder='enter full address'required>
</textarea>
</td>
</tr>
<tr>
...
<select name='oc' required>
    ...
    <option value="Electrician">R.O SERVICES</option>
    <option value="Electrician">Water heater or Gear SERVICES</option>
