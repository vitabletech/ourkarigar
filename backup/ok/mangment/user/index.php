...
$sql ="SELECT * FROM user WHERE email=:uname and Pass=:password";
...
<html lang="en">
    <head>
        ...
        <!-- Title -->
        <title>OURKARIGAR.COM | Home Page</title>
                ...
                <nav class="cyan darken-1">
                    <div class="nav-wrapper row">
                        ...
                        <div class="header-title col s3">
                            <span class="chapter-title"><font color :black>OURKARIGAR.COM</font></span>
                        </div>
...
-->
        ...
        <!--  <div class="footer">
            ...
            <main class="mn-inner">
                <div class="row">
                    <div class="col s12">
                        <div class="page-title"><h4>LOGIN HERE</h4></div>
